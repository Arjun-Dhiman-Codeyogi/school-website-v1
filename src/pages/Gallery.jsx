...
const galleryCategories = {
  campus: {
    ...
    images: [
      { id: 1, src: '../src/assets/mainBuilding.jpg', label: 'Main Building', color: 'from-blue-500/20 to-cyan-500/20', desc: 'The iconic main building with colonial architecture and modern amenities.' },
      { id: 2, src: '../src/assets/prayer.jpeg', label: 'prayer Time', color: 'from-amber-500/20 to-orange-500/20', desc: 'Prayer time.' },
      { id: 3, src: '../src/assets/sciencelab.jpg', label: 'Science Lab', color: 'from-green-500/20 to-emerald-500/20', desc: 'State-of-the-art physics, chemistry, and biology laboratories.' },
      { id: 4, src: '../src/assets/computerlab.jpg', label: 'Computer Lab', color: 'from-purple-500/20 to-violet-500/20', desc: '60+ computers with high-speed internet for digital learning.' },
      { id: 5, src: '../src/assets/sportGround.jpg', label: 'Sports Ground', color: 'from-red-500/20 to-pink-500/20', desc: 'Multi-sport facility with cricket, football, basketball, and athletics tracks.' },
      { id: 6, src: '../src/assets/audio.jpg', label: 'Auditorium', color: 'from-indigo-500/20 to-blue-500/20', desc: '800-seat auditorium with professional lighting and sound systems.' },
      { id: 7, src: '../src/assets/office.jpg', label: 'School Office', color: 'from-cyan-500/20 to-teal-500/20', desc: 'Main Office of Public Inter College' },
      { id: 8, src: '../src/assets/walk.webp', label: 'Walk Area', color: 'from-yellow-500/20 to-amber-500/20', desc: 'Daily walk area for students and staff.' },
    ],
  },
  events: {
    label: 'Events & Celebrations',
    images: [
      { id: 9, src: '../src/assets/tree.jpeg', label: 'Tree Planting', color: "Our Math's senior teacher is planting tree." },
      { id: 10, src: '../src/assets/sport.jpeg', label: 'Sports Meet', color: 'from-orange-500/20 to-red-500/20', desc: 'Before starting the inter-house sports competition with over 300 participants.' },
      { id: 11, src: '../src/assets/physic.jpg', label: 'Science Fair', color: 'from-teal-500/20 to-green-500/20', desc: 'Students showcasing innovative projects and experiments.' },
      { id: 12, src: '../src/assets/cultrul.jpeg', label: 'Cultural Fest', color: 'from-violet-500/20 to-purple-500/20', desc: 'A celebration of art, music, dance, and drama performances.' },
      { id: 13, src: '../src/assets/idep.jpeg', label: 'Republic Day', color: 'from-orange-500/20 to-amber-500/20', desc: 'Flag hoisting ceremony with Principle and guests attending.' },
      { id: 14, src: '../src/assets/Rangoli.jpeg', label: 'Graduation Day', color: 'from-blue-500/20 to-indigo-500/20', desc: 'Celebrating the Rangoli day.' },
    ],
  },
  classroom: {
    label: 'Classroom Activities',
    images: [
      { id: 15, src: '../src/assets/artclass.jpeg', label: 'Art Class', color: 'from-rose-500/20 to-pink-500/20', desc: 'Creative expression through painting, sketching, and mixed media.' },
      { id: 16, src: '../src/assets/grouppro.jpg', label: 'Group Project', color: 'from-emerald-500/20 to-green-500/20', desc: 'Collaborative learning through team-based projects.' },
      { id: 17, src: '../src/assets/smartclass.jpeg', label: 'Smart Classroom', color: 'from-blue-500/20 to-cyan-500/20', desc: 'Interactive smart boards enhancing digital learning.' },
      { id: 18, src: '../src/assets/debate.jpg', label: 'Debate Session', color: 'from-red-500/20 to-orange-500/20', desc: 'Sharpening communication and critical thinking skills.' },
    ],
  },
};
