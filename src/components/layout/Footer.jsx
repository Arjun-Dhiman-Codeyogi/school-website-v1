...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary text-secondary-foreground mt-auto transition-colors duration-300">
      {/* Newsletter */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <Card className="border-0 shadow-none bg-transparent">
            <CardContent className="p-0">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold font-heading">Public Inter College</span>
              </div>
          ...
          {/* Contact Info with Popover social links */}
          <Card className="border-0 shadow-none bg-transparent">
            <CardContent className="p-0">
              ...
              <div className="flex gap-3 mt-4">
                <a href="#" aria-label="Facebook" className="h-9 w-9 rounded-full bg-[#1877F2]/10 flex items-center justify-center hover:bg-[#1877F2]/25 transition-colors hover:scale-110">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="#1877F2">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="#" aria-label="Instagram" className="h-9 w-9 rounded-full bg-gradient-to-tr from-[#F58529]/10 via-[#DD2A7B]/10 to-[#8134AF]/10 flex items-center justify-center hover:from-[#F58529]/25 hover:via-[#DD2A7B]/25 hover:to-[#8134AF]/25 transition-all hover:scale-110">
                ...
                <a href="#" aria-label="YouTube" className="h-9 w-9 rounded-full bg-[#FF0000]/10 flex items-center justify-center hover:bg-[#FF0000]/25 transition-colors hover:scale-110">
